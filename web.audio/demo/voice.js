! function(e) {
    function t(e) {
        if (!m) {
            ...
            p || (p = $("<div id='_voice_mask' data-for='result'/>")), p.css({
                opacity: .3,
                position: "absolute",
                background: "#000",
                "z-index": e["z-index"],
    ...
    var i, a, o, s = function() {
        ...
        d = navigator.userAgent.match(/Windows NT ([\d\.]*)/);
    d ? d[1] <= 5.1 && (u = "xp") : (d = navigator.userAgent.match(/Mac OS/)) && (u = "mac");
    var h = function(e, t) {
        function r(e, t) {
            var r = parseInt(1e5 * Math.random()) + "_" + (new Date).getTime();
            e && (e.eventId = r), p.postMessage(e), t && (g[r] = t)
        }
                ...
                if (n) {
                    ...
                    w.push(i), i.always(function(t) {
                        ...
                        return w = $.grep(w, function(e) {
                            return i !== e
                        }), !t || t && t.result && 0 != t.result.err_no ? void e.stop(!0) : (t && t.content && t.content.item && (x = t, A.result.fire(t)), (t && t.result && (3 == t.result.res_type || 5 == t.result.res_type) || !t.result) && e.stop(!0), void((r || t && t.result && t.result.idx < 0) && e.stop(!0)))
                    })
                }
            }, r)
        }
        ...
        u.eq;
        var l = u.bufferLen || 4096;
        this.context = i.context;
        var d = 1,
            h = 1;
        this.node = this.context.createScriptProcessor(l, d, h);
        var p = new Worker(u.workerPath || s());
        p.postMessage({
            command: "init",
            config: {
                outputChannels: h,
                outputSampleRate: 8e3,
                uid: Cookie.get("BAIDUID"),
                sampleRate: this.context.sampleRate
            }
        });
        var g = {};
        p.onmessage = function(e) {
            e.data && e.data.eventId && "function" == typeof g[e.data.eventId] && (g[e.data.eventId](e.data.data), g[e.data.eventId] = null)
        };
        var m = !1;
        this.node.onaudioprocess = function(e) {
            if (m) {
                var t, n = [];
                for (t = 0; h > t; t++) n.push(e.inputBuffer.getChannelData(t));
                r({
                    command: "record",
                    buffer: n
                }), A.audioprocess.fire(e);
                var i = e.inputBuffer.getChannelData(0),
                    a = Math.max.apply(Math, i),
                    o = 0;
                $.each(i, function(e, t) {
                    o += Math.abs(t - a)
                }), o /= i.length, b.maxVolumn = Math.max(a, b.maxVolumn || 0), b.maxAvgDiff = Math.max(o, b.maxAvgDiff || 0)
            }
        ...
        var v;
        this.start = function() {
            m || (this.reinit(), A.start.fire(), n(this), m = !0, v = setInterval(function() {
                n(b)
            }, 100), o && (clearTimeout(o), o = null), this.maxVolumn = 0, this.maxAvgDiff = 0, o = setTimeout(function() {
                clearTimeout(o), o = null, (b.maxVolumn < f || b.maxAvgDiff < c) && A.volumnLow.fire()
            }, 3e3))
        };
        var A = {},
            b = this;
        $.each(["audioprocess", "stop", "start", "finish", "stop", "result", "fail", "noUserMedia", "volumnLow"], function(e, t) {
            A[t] = $.Callbacks(), b["on" + t] = function(e) {
                A[t].add(e)
            }
        }), this.removeEventListener = function(e, t) {
            "undefined" == typeof t ? A[e].empty() : A[e].remove(t)
        }, e && e.addEventListener && e.addEventListener("ended", function() {
            A.noUserMedia.fire(), e.removeEventListener(arguments.callee)
        }), this.stop = function(e) {
            m && (e ? ($.each(w, function(e, t) {
                t.abort()
            }), w = [], x ? A.finish.fire(x) : A.fail.fire(), m = !1) : n(this, !0), A.stop.fire(e)), clearInterval(v), o && (clearTimeout(o), o = null)
        }, this.clear = function() {
            r({
                command: "clear"
            }, cb)
    ...
    e.URL = e.URL || e.webkitURL, navigator.getUserMedia = navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia || navigator.msGetUserMedia, e.AudioContext = e.AudioContext || e.webkitAudioContext, h.lowVolumnTipUrl = l[u], h.support = function() {
        return navigator.getUserMedia && e.URL && e.AudioContext && e.Worker ? !0 : !1
    }, h.log = function() {};
    var p, g, m = !1,
        v = $("body"),
        A = function() {
            ...
            return function(c) {
                ...
                function l(e) {
                    e.removeEventListener("audioprocess"), o.get(0).style.cssText = "", a.get(0).style.cssText = "", s.hide()
                }
                e || (e = $("<div id='voice' data-for='result'><div class='close'>x</div><div class='result'><span class='result-word'></span><span class='tip'></span></div><div class='voice_inner'><img class='btn' src='https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/voice/imgs/start_btn_e61e030.png'><div class='box'><div class='box_inner'></div></div><div class='round2'></div><div class='round1'></div><div class='round3'></div></div></div>"), n = $(".btn", e), i = $(".result-word", e), f = $(".tip", e), a = $(".box_inner", e), o = $(".round3", e), s = $(".round2,.round1", e)), f.mousedown(function() {
                    h.log({
                        q: "setVolumn"
                    })
                }), $(".close", e).click(function() {
                    c.stop(!0), c.closeUI(), r(), h.log({
                        q: "close"
                    })
                }), c.closeUI = function() {
                    e.remove(), r()
                    ...
                    i.html("请说话"), n.one("click", function() {
                        l(c), i.html("识别中..."), c.stop(), h.log({
                            q: "manual_stop"
                        })
                    }), f.hide()
                }), c.onfail(function(e) {
                    var t = "识别失败，请点击下面按钮后再说一次";
                    e && e.result && "-3005" == e.result.err_no && (t = "没听清楚，请点击下面按钮后再说一次"), i.html(t), l(c), n.unbind("click").one("click", function() {
                        c.start(), u(), h.log({
                            q: "manual_restart"
                        })
                    })
                }), c.onvolumnLow(function() {
                    var e = h.lowVolumnTipUrl;
    ...
    h.showTip = function() {
        ...
        e = bds && bds.se && bds.se.upn && bds.se.upn.cookieset && bds.se.upn.cookieset[0] && 2 == bds.se.upn.cookieset[0].v ? $.extend(e, {
            ...
            right: "inherit",
            width: "100%"
        }), g || (g = $('<div><img src="https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/voice/imgs/allow_d7a970f.png" usemap="#voiceTipMap"/><map name="voiceTipMap"><area shape="circle" coords="13,55,8"></map></div>').css(e), g.find("area").click(function() {
            h.hideTip(), h.log({
                q: "hideTip"
            })
        })), g.appendTo(v).show()
    ...
    ! function() {
        ...
        var o = "11.1.0",
            s = "playerProductInstall.swf",
            f = {},
            c = {};
        c.quality = "high", c.bgcolor = "#ffffff", c.allowscriptaccess = "always", c.allowfullscreen = "false";
        var u = {};
        u.id = "flash_recorder", u.name = "flash_recorder", u.align = "middle";
        var l = !1,
            d = "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/voice/imgs/start_btn_flash_cae818f.png",
            h = "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/voice/imgs/start_btn_disabled_flash_8390a38.png";
        /MSIE 6.0/.test(navigator.userAgent), $.each([d, h], function(e, t) {
            var r = new Image;
            r.src = t
        });
        var p = function(e) {
            var t = this,
                r = {
                    ...
                    BlueMicoUrl: d,
                    GrayMicoUrl: h,
                    swfUrl: "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/voice/js/flash_recorder.swf"
                };
            $.extend(t, r, e), this.callbacks = {}, $.each(["stop", "start", "finish", "result", "fail", "volumnLow"], function(e, r) {
                t.callbacks[r] = $.Callbacks(), t["on" + r] = function(e) {
                    t.callbacks[r].add(e)
                }
            })
        };
        p.addStyle = function() {
            e();
            var t = "#voice{font-family:\"microsoft yahei\";overflow:hidden;z-index:1000;box-shadow:0 5px 5px #888;position:fixed;width:100%;height:38.2%;min-height:229.2px;background:#fff;font-size:16px;bottom:0;_position: absolute;_bottom: auto;_clear: both;_top:expression(eval(document.compatMode && document.compatMode=='CSS1Compat') ? documentElement.scrollTop+(documentElement.clientHeight-this.clientHeight) - 1 : document.body.scrollTop +(document.body.clientHeight-this.clientHeight) - 1);}#voice .close{z-index:1;display:block;position:absolute;right:30px;top:20px;font-size:0px;color:#333;cursor:pointer;text-indent:-10000px;background:url(https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/voice/imgs/mic_flash_5e0736d.png) no-repeat;width:20px;height:20px;}#voice .close:hover{color:#999;background-position:0 -21px}#voice .voice_inner{margin:10px auto 0;width:280px;}#voice .result{width:100%;font-size:22px;padding-top:40px;text-indent:63px;text-align:left;position:absolute;left:0;}#voice .result .tip{color:#999;font-size:14px;}";
            n(t, "forResult")
        };
        var g = function() {
            var e, n, a;
            return function(d) {
                e || (e = $("<div id='voice' data-for='result'><a href='javascript:void(0);' class='close'>x</a><div class='result'><span class='result-word'></span><span class='tip'></span></div><div class='voice_inner'><div id='voice_flashContent'></div></div></div>").appendTo("body"), n = e.find(".result-word"), a = $(".tip", e), swfobject.embedSWF(d.swfUrl, "voice_flashContent", "280", "280", o, s, f, c, u, function(e) {
                    d.swf = e.ref
                }), t(), $(".close", e).click(function() {
                    l || d.stop(!0), d.closeUI(), r()
                }), a.mousedown(function() {
                    p.log({
                        q: "setVolumn"
                    })
                })), d.closeUI = function() {
                    e.css("margin-left", "-32767px"), r()
                }, d.openUI = function() {
                    e.css("margin-left", "0"), t()
                }, d.onstop(function(e) {
                    e.notSendLastPack || n.html("识别中...")
                }), d.onfinish(function() {
                    d.closeUI(), r(), a.hide()
                }), d.onresult(function(e) {
                    n.html(e.content.item[0]), a.hide()
                }), d.onstart(function() {
                    n.html("请说话"), a.hide()
                }), d.onfail(function(e) {
                    var t = "识别失败，请点击下面按钮后再说一次";
                    e && e.result && "-3005" == e.result.err_no && (t = "没听清楚，请点击下面按钮后再说一次"), n.html(t)
                }), d.onvolumnLow(function() {
                    var e = i;
                    a.html(' (音量小，请您检查麦克风设置，或参考<a href="' + e + '" target="_blank">这里</a>进行设置)').show()
                }), m.defer.done(function() {
                    d.start()
                })
            }
        }();
        p.support = function() {
            return swfobject.hasFlashPlayerVersion(o)
        }, p.flash_loaded = function() {
            m.defer.resolve(m.obj)
        }, p.flash_noMicrophone = function() {
            m.obj.BlueMicoUrl = m.obj.GrayMicoUrl, m.obj.config(), l = !0, m.defer.reject()
        }, p.recorder_enable = function() {
            l = !1
        }, p.recorder_disabled = function() {
            l = !0
        }, $.each(["start", "stop", "finish", "result", "fail", "volumnLow"], function(e, t) {
            p[t] = function(e) {
                if (!m) throw new Error(t + " be called before recorder initial");
                var r = m.obj;
                e = e && $.parseJSON(e), r.callbacks[t].fire(e)
            }
        });
        var m;
        p.init = function(e) {
            var t = $.Deferred(),
                r = !1;
            return m && (r = !0), m = m || {}, m.defer = t, m.obj = m.obj || new p(e), g(m.obj), r && t.resolve(m.obj), t
        }, $.extend(p.prototype, {
            clear: function() {
                var e = this;
...
}(window), "function" == typeof define && define("voice/js/voice", ["require"], function() {
